...
export class AnimationBuilder<
  ...
  O extends AnimationOptions<T>
> implements AnimationObject<T, O>
{
  public type: T;
  public options: O;
  ...
  public static start<T extends AnimationType, O extends AnimationOptions<T>>(
    type: T
  ): AnimationBuilder<T, O> {
