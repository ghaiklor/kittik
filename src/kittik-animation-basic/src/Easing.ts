...
export function inElastic (t: number, b: number, c: number, d: number) {
  let s = 1.70158
  const p = d * 0.3
  let a = c
...
export function outElastic (t: number, b: number, c: number, d: number) {
  let s = 1.70158
  const p = d * 0.3
  let a = c
...
export function inOutElastic (t: number, b: number, c: number, d: number) {
  let s = 1.70158
  const p = d * (0.3 * 1.5)
  let a = c
...
export function inBack (t: number, b: number, c: number, d: number) {
  const s = 1.70158
  return c * (t /= d) * t * ((s + 1) * t - s) + b
}

export function outBack (t: number, b: number, c: number, d: number) {
  const s = 1.70158
  return c * ((t = t / d - 1) * t * ((s + 1) * t + s) + 1) + b
}

export function inOutBack (t: number, b: number, c: number, d: number) {
  let s = 1.70158
